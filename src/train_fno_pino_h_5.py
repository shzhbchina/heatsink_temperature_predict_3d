...
'''
python /workspace/src/train_fno_pino_h_5.py \
    ...
    for ep in range(start_ep, args.epochs+1):
        ...
        for x, y, cond in dl:
            ...
            if "h_truth_t0" in cond and cond["h_truth_t0"] is not None:
                ...
                raise ValueError(f"missing h_truth_t0")
            ...
            if args.use_pde:
                ...
                pde = (((res_p/(scale+1e-8))**2) * mask_int ).sum() / (mask_int .sum() + 1e-8)
